 ...
 * File Name:DrivingTestOutVO.java  
 * Package Name:com.aido.manager.dto.drivingTest  
 * Date:2017年1月11日下午1:50:41  
...
public class DrivingTestOutVO implements Serializable{
	...
	public String getAnswerUS() {
		return answerUS;
	}

	public void setAnswerUS(String answerUS) {
		this.answerUS = answerUS;
	}
