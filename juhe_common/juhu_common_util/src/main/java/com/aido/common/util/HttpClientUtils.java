...
public class HttpClientUtils {
	 ...
	 * @return
	 * @throws Exception
	 * @author nibili 2016年10月19日
	 */
	public static String get(String url, Map<String, String> paramsMap, Map<String, String> headersMap) throws Exception {
		HttpUriRequest request = new HttpGet(toRequestUrl(url, paramsMap));
		if (MapUtils.isNotEmpty(headersMap) == true) {
	...
	public static String post(String url, Object object) throws Exception {
		HttpUriRequest request = postForm(url, null, HttpClientUtils.reflectObjectFieldsToMap(object), null);
		return HTTP_CLIENT.execute(request, new BasicResponseHandler());
	}
	...
	public static String post(String url, Map<String, String> params) throws Exception {
		HttpUriRequest request = postForm(url, null, params, null);
		return HTTP_CLIENT.execute(request, new BasicResponseHandler());
	}
	 ...
	 */
	public static String post(String url, String body, Object paramObject, Object headerObject) throws Exception {
		HttpUriRequest request = postForm(url, body, HttpClientUtils.reflectObjectFieldsToMap(paramObject), HttpClientUtils.reflectObjectFieldsToMap(headerObject));
		return HTTP_CLIENT.execute(request, new BasicResponseHandler());
	}
	 ...
	 * @author nibili 2016年10月18日
	 */
	public static String post(String url, String body, Map<String, String> params, Map<String, String> headers) throws Exception {
		HttpUriRequest request = postForm(url, body, params, headers);
		return HTTP_CLIENT.execute(request, new BasicResponseHandler());
	}
	 ...
	 * @author nibili 2016年10月18日
	 */
	private static HttpUriRequest postForm(String url, String body, Map<String, String> params, Map<String, String> headers) throws UnsupportedEncodingException {
